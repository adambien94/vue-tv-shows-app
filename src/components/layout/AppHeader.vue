<template>
  <header class="bg-primary backdrop-blur-sm border-b border-b-white/5 sticky top-0 z-[2] w-full">
    <nav class="container px-4 lg:px-12 py-2 lg:py-3 flex justify-between items-center gap-4 w-full">
      <RouterLink to="/" class="text-text-primary text-3xl font-black shrink-0"
