  ...
  <div>
    ...
    <div class="mt-2 sm:mt-4 relative lg:px-12 group">
      ...
      <div ref="scrollContainer"
        class="overscroll-x-contain px-4 lg:-mx-4 flex items-start gap-4 [--fade-length:18px] overflow-x-scroll pb-4 sm:pb-6 scroll-smooth scrollbar-hide lg:[mask-image:linear-gradient(to_right,transparent,black_var(--fade-length),black_calc(100%-var(--fade-length)),transparent)]"
        @scroll="handleScroll">
        <slot name="items" />
      </div>
