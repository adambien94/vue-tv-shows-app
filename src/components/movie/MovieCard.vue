<template>
  <RouterLink class="card block flex-shrink-0 select-none hover:brightness-[0.7] transition-all duration-300" :to="{
    ...
    <div
      :class="['relative w-full aspect-[5/7] before:absolute before:inset-0 after:rounded-[inherit] after:mix-blend-plus-lighter before:bg-white/10 rounded-lg lg:rounded-2xl overflow-hidden blend-border', { skeleton: !isLoaded && img }]">
